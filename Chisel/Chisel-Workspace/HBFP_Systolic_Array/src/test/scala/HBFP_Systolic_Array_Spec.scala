...
class HBFP_GEMMSpec extends AnyFlatSpec with ChiselScalatestTester {
  "mult" should "pass" in {
    ...
    test(new SystolicArray_HBFP_forTesting(blockSize, n, m, e)).withAnnotations(Seq(TargetDirAnnotation("test/HbfpPass/HBFP"), WriteVcdAnnotation , VerilatorBackendAnnotation )) {
      ...
      // Load the CSV file
        val file1 = new File("/home/vpatel/Documents/Chisel/Chisel-Workspace/HBFP_Systolic_Array/src/test/scala/HBFP_Systolic_Array1.csv")
        val lines1 = Source.fromFile(file1).getLines().toList

        val file2 = new File("/home/vpatel/Documents/Chisel/Chisel-Workspace/HBFP_Systolic_Array/src/test/scala/HBFP_Systolic_Array2.csv")
