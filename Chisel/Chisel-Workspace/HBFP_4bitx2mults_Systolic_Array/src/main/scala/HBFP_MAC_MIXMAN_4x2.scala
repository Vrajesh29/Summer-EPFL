...
class HBFP_MAC(blockSize: Int, m: Int, e: Int) extends Module{
    ...
    val exp_addition = ShiftRegister(io.in.a.exp +& io.in.b.exp, 5) // The exponents are added and shifted by 5 cycles to match the latency of the multiplier
    ...
    for (i <- 0 until blockSize) {
      ...
      when (counter === 0.U){
        ...
        partial_result := multiplier_1.io.out +& (multiplier_2.io.out << 4.U)
      }
      .otherwise{
        multiplier_1.io.in.a <> Mux(io.in.flag === 1.B, io.in.a.man(i)(3,0), io.in.a.man(i))
        multiplier_1.io.in.b <> Mux(io.in.flag === 1.B, (padding ## io.in.b.man(i)(m-1,m-2)), io.in.b.man(i))
        multiplier_2.io.in.a <> Mux(io.in.flag === 1.B, (padding ## io.in.a.man(i)(m-1,m-2)), 0.U)
        multiplier_2.io.in.b <> Mux(io.in.flag === 1.B, (padding ## io.in.b.man(i)(m-1,m-2)), 0.U)
        partial_result := Mux(io.in.flag === 1.B, partial_result +& (multiplier_1.io.out << 4.U) +& (multiplier_2.io.out << 8.U), multiplier_1.io.out +& (multiplier_2.io.out << 4.U))
      }
