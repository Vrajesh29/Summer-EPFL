...
class HBFP_MAC_MIXMAN_4x4(blockSize: Int, m: Int, e: Int) extends Module{
  ...
  if (m == 6.toInt){
    ...
    for (i <- 0 until blockSize) {
      ...
      val multiplication = io.in.a.man(i)(3,0) * io.in.b.man(i)(3,0) +& (((padding ## io.in.a.man(i)(5,4)) * io.in.b.man(i)(3,0)) << 4.U) +& ((io.in.a.man(i)(3,0) * (padding ## io.in.b.man(i)(5,4))) << 4.U) +& (((padding##io.in.a.man(i)(5,4)) * (padding##io.in.b.man(i)(5,4))) << 8.U)
...
class HBFP_PE_MIXMAN_4x4(blockSize: Int, m: Int, e: Int) extends Module{
  val io = IO(new Bundle{
    val in = Input(new Bundle{
...
// The below systolic array is good, but only for testing purposes. The real systolic array is after this one.
  class SystolicArray_HBFP_forTesting_MIXMAN_4x4(blockSize: Int, n: Int, m: Int, e: Int) extends Module {
    val io = IO(new Bundle {
        val in = Input(new Bundle {
  ...
  val pes = Seq.fill(n, n)(Module(new HBFP_PE_MIXMAN_4x4(blockSize, m, e)))
...
object SystolicArray_HBFP_forTesting_MIXMAN_4x4Main extends App {
  emitVerilog(new SystolicArray_HBFP_forTesting_MIXMAN_4x4(4, 2, 6, 8))
}